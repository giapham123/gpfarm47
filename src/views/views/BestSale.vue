<template>
  <div>
    <v-card-title class="text-center justify-center py-6">
      <h1 class="font-weight-bold text-h4 basil--text">Sản Phẩm Bán Chạy</h1>
    </v-card-title>
    <v-sheet>
      <v-slide-group v-model="model" show-arrows>
         <v-slide-item v-for="(item,index) in lsNewProduct" :key="index" v-slot="{ toggle }">
          <v-card outlined class="ma-4" @click="toggle">
                ...
                <v-card outlined @click="moveToDetails(item)">
                  <div class="img">
                    <!-- <v-img
                      contain
                      class="child"
                      src="https://i.pinimg.com/originals/8b/4e/38/8b4e389fefdbac5652fd9a24e89bd887.jpg"
                    ></v-img> -->
                    <v-img
                     width="200"
                      height="250"
